            ...
            if (ISA == 1) {
                ...
                for (int po = 0; po < program.length(); po++) {
                    ...
                    if (nibble == 0x0) {
                        ...
                        if (log) std::cout << "popa2 reg[0]=" << reg[0] << std::endl;
                    } else if (nibble == 0x7) {
                        if (stkc[1] >= 0) {
                            reg[1] = stk2[stkc[1]];
                            stkc[1]--;
                        }
                        if (log) std::cout << "popb2 reg[1]=" << reg[1] << std::endl;
                    } else if (nibble == 0x8) {
                        stkc[0]++;
                        stk1[stkc[0]] = reg[0];
                        if (log) std::cout << "pusha reg[0]=" << reg[0] << std::endl;
                        ...
                        stkc[1]++;
                        stk2[stkc[1]] = reg[0];
                        if (log) std::cout << "pusha2 reg[0]=" << reg[0] << std::endl;
                    } else if (nibble == 0xb) {
                        stkc[1]++;
                        stk2[stkc[1]] = reg[1];
                        if (log) std::cout << "pushb2 reg[1]=" << reg[1] << std::endl;
                    } else if (nibble == 0xc) {
                        reg[0] = reg[0] + reg[1];
                        if (log) std::cout << "add reg[0]=" << reg[0] << std::endl;
                    } else if (nibble == 0xd) {
                        ...
                        if (po + 1 < program.length()) {
                            ...
                            if (nibble2 == 0x0) {
                                ...
                                if (po + 1 < program.length()) {
                                    ...
                                    if (nibble3 == 0x2) {
                                        po = reg[0];
                                        if (log) std::cout << "jmpa reg[0]=" << reg[0] << std::endl;
                                    } else if (nibble3 == 0x3) {
                                        po = reg[1];
                                        if (log) std::cout << "jmpb reg[1]=" << reg[1] << std::endl;
                                    }
                                } else {
                                    po--;
                                }
                                ...
                                stkc[0]++;
                                stk1[stkc[0]] = input;
                                if (log) std::cout << "ina stk1=" << input << std::endl;
                            } else if (nibble2 == 0x5) {
                                int input;
                                if (!quiet) std::cout << "input: ";
                                std::cin >> input;
                                stkc[1]++;
                                stk2[stkc[1]] = input;
                                if (log) std::cout << "inb stk2=" << input << std::endl;
                            } else if (nibble2 == 0x6) {
                        ...
                        if (po + 1 < program.length()) {
                            ...
                            if (nibble2 == 0x0) {
                                ...
                                if (po + 1 < program.length()) {
                                    po++;
                                    char hex3 = program[po];
                                    int val3 = (hex3 >= 'a') ? (hex3 - 'a' + 10) : (hex3 - '0');
                                    if (po + 1 < program.length()) {
                                        po++;
                                        char hex4 = program[po];
                                        int val4 = (hex4 >= 'a') ? (hex4 - 'a' + 10) : (hex4 - '0');
